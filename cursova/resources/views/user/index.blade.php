            ...
            @foreach($hit_products  as $hit_product)
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            <a href="{{route('add-to-cart',['id'=>$hit_product->id])}}" class="btn btn-lg btn-outline-dark">
                                Купити
                            </a>
                            <a href="{{route('product-card',['id'=>$hit_product->id])}}" class="btn btn-lg btn-outline-dark">
                                Деталі
                            </a>
                        </div>
                    </div>
